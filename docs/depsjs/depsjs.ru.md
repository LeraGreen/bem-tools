# Технология для декларирования зависимостей по БЭМ
...
Способы формирования страницы:
* [Статический](#Статический-способ-формирования-страницы) — сборка страницы на основе описанного БЭМ-дерева.
* [Динамический](#Динамический-способ-формирования-страницы) — предварительная сборка статических файлов (CSS, JS, шаблоны), с последующим формированием динамического БЭМ-дерева в runtime.

### Статический способ формирования страницы

В случае статического способа формирования страницы БЭМ-дерево содержит все БЭМ-сущности, кроме блоков:
...
Если в БЭМ-дереве указан какой-то блок, то в процессе сборки все необходимые для блока технологии (CSS, JS, BEMHTML, ...) будут автоматически собраны в общие файлы для всего проекта со всех уровней переопределения.

[Пример статического способа формирования страницы](https://github.com/bem/project-stub/tree/static-bem-project).

### Динамический способ формирования страницы

При динамическом способе формирования страницы БЭМ-дерево отсутствует. Поэтому необходимо задекларировать нужные БЭМ-сущности для предварительной генерации страницы.

[Пример динамического способа формирования страницы](https://github.com/bem/bem-express/tree/dynamic-bem-project).
